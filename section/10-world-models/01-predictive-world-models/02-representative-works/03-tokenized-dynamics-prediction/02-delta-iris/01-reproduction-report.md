...
![复现流程](../../../repro_assets/reproduction_pipeline.png)
...
![验证矩阵](../../../repro_assets/validation_matrix.png)
...
![硬件环境](../../../repro_assets/hardware_snapshot.png)
...
![Smoke 轨迹](../../../repro_assets/smoke_trajectories.png)
...
![长训进度](../../../repro_assets/training_progress_snapshot.png)
...
![首轮耗时](../../../repro_assets/epoch1_stage_times.png)

*图 6：首轮包含 100k 随机预填充和额外的 tokenizer/world-model 更新，因此不能直接当作稳态 epoch。*

![阶段耗时对比](../../../repro_assets/epoch_stage_comparison.png)
...
![动作分布变化](../../../repro_assets/action_distribution_shift.png)
...
![最佳真实轨迹](../../../repro_assets/formal_best_episode_events.png)
...
![Tokenizer 重建](../../../repro_assets/tokenizer_reconstruction.png)
...
![World model 单步](../../../repro_assets/world_model_prediction.png)

*图 13：世界模型单步想象与真实下一帧。误差主要集中在具有随机性的实体位置。*

![重建与想象总览](../../../repro_assets/model_visual_comparison.png)

*图 14：同一 transition 上的真实帧、tokenizer 重建与 world-model 想象总览。*

WorldModelEnv 内部使用分类分布采样 Δ-token 和 done，因此相同历史/动作可生成不同结果：

![随机样本](../../../repro_assets/world_model_stochastic_samples.png)
...
![产物布局](../../../repro_assets/artifact_layout.png)
...
| 报告图片 | <code>$REPO_ROOT/repro_assets/</code> |
